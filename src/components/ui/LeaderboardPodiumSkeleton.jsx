...
const LeaderboardPodiumSkeleton = ({ className = '' }) => (
  <div className={`w-full overflow-x-auto pb-12 pt-8 -mt-8 text-center whitespace-nowrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden block ${className}`}>
    <div className="inline-flex items-end justify-center gap-4 md:gap-7 px-6 pt-10 mt-2 mx-auto text-left whitespace-normal align-top animate-pulse">
      {/* P3 */}
